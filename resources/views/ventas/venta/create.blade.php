...
@section ('contenido')
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				<label for="serie_comprobante">Serie Comprobante</label>
				 <input type="text" name="serie_comprobante" value="{{old('serie_comprobante')}}" class="form-control" placeholder="Serie....">
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				 <label for="num_comprobante">Numero Comprobante</label>
				 <input type="text" name="num_comprobante" required value="{{old('num_comprobante')}}" class="form-control" placeholder="Numero....">
			</div>
		</div>
	...
	<script>
		alert("estoy en el script");

		$(document).ready(function(){
			alert("estoy dentro del ready");
			$('#bt_add').click(function(){
				alert("no estoy aquiiii");
				agregar();
			});
			...
			if (idarticulo!="" &&  cantidad!="" && cantidad>0 && precio_venta!="") 
			{
				...
				{  
					...
					$('#detalles').append(fila);
				 	...
				 	alert("La cantidad excede el stock del producto");
				 }	
			}else 
			{
				alert("Error al ingresar el detalle de la venta del articulo");
			}
